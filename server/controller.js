module.exports = {
    ...
    addHouse(req,res){
        const {house_name, address, city, property_state, zip, img, mortgage, rent} = req.body;
        let db = req.app.get('db');
        console.log(req.body);
        db.add_house([house_name, address, city, property_state, zip, img, mortgage, rent]).then(
